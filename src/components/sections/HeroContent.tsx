...
export default function HeroSection() {
  ...
  return (
    <section id="beranda" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 py-8 rounded-3xl backdrop-blur-md bg-white/20 dark:bg-black/20 border border-white/30 dark:border-white/20 shadow-2xl max-w-3xl mx-auto">
        ...
        <p className="text-lg md:text-xl text-gray-800 dark:text-gray-100 max-w-2xl mx-auto mb-4 font-medium">
